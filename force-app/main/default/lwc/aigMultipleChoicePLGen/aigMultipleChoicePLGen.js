...
import AIG_AI_USE_CASE_RISK_MESSAGE_CHANNEL from '@salesforce/messageChannel/aigAIUseCaseRiskMessageChannel__c'; 
...
export default class AigMultipleChoicePLGen extends LightningElement {
    ...
    saveResponse() {
        ...
        .then(() => {
            ...
            publish(this.messageContext, AIG_AI_USE_CASE_RISK_MESSAGE_CHANNEL, message);
