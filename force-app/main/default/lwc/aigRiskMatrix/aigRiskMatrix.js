...
import AIG_AI_USE_CASE_RISK_MESSAGE_CHANNEL from '@salesforce/messageChannel/aigAIUseCaseRiskMessageChannel__c'; // Import your message channel
    ...
    subscribeToMessageChannel() {
        if (!this.subscription) {
            this.subscription = subscribe(
                this.messageContext,
                AIG_AI_USE_CASE_RISK_MESSAGE_CHANNEL,
